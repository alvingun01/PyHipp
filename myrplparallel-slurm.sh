...
#print(time.localtime()); \
#print(time.time()-t0);"
#aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:785788241387:awsnotify --message "JobDone"
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:785788241387:awsnotify --message "RPLParallelJobDone"
